...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.18.0_1/nim/lib -o /Users/nao/Documents/ray/nim-ray/nimcache/filewrite.o /Users/nao/Documents/ray/nim-ray/nimcache/filewrite.c */
...
N_LIB_PRIVATE N_NIMCALL(NF, clamp_MP3SGCxfFIDw6O0yuRRW0g)(NF x);
static N_INLINE(void, nimFrame)(TFrame* s);
N_LIB_PRIVATE N_NOINLINE(void, stackOverflow_II46IjNZztN9bmbxUD8dt8g)(void);
static N_INLINE(void, popFrame)(void);
N_LIB_PRIVATE N_NIMCALL(NI, to255_BuAG9bvAB6AGfXCWB7MgNVg)(NF x);
...
;
STRING_LITERAL(TM_DOEFk8Ga9aqsEo1I9b5I20kA_15, "output: ", 8);
STRING_LITERAL(TM_DOEFk8Ga9aqsEo1I9b5I20kA_17, "done", 4);
NIM_CONST tyArray_nHXaesL0DJZHyVS07ARPRA TM_DOEFk8Ga9aqsEo1I9b5I20kA_16 = {((NimStringDesc*) &TM_DOEFk8Ga9aqsEo1I9b5I20kA_17)}
;
...
appendString(T18_, T24_);
	...
	}
	{
		...
		T28_ = rawNewString(fileName->Sup.len + 8);
appendString(T28_, ((NimStringDesc*) &TM_DOEFk8Ga9aqsEo1I9b5I20kA_15));
appendString(T28_, fileName);
		T27_[0] = T28_;
		echoBinSafe(T27_, 1);
		nimln_(24, "filewrite.nim");
		echoBinSafe(TM_DOEFk8Ga9aqsEo1I9b5I20kA_16, 1);
	}
